...
- [Toronto Annotation Suite](https://aidemos.cs.toronto.edu/toras/) - Web-based AI-powered annotation platform. Supports AI-assisted image annotation, and user & data management system.
